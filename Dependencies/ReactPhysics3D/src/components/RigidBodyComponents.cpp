...
RigidBodyComponents::RigidBodyComponents(MemoryAllocator& allocator)
                    :Components(allocator, sizeof(Entity) + sizeof(RigidBody*) +
                                ...
                                sizeof(bool) + sizeof(bool) + sizeof(List<Entity>) + sizeof(bool)) {
...
void RigidBodyComponents::allocate(uint32 nbComponentsToAllocate) {
    ...
    bool* newIsRotationFreezed = reinterpret_cast<bool*>(newJoints + nbComponentsToAllocate);
    ...
    if (mNbComponents > 0) {
        ...
        memcpy(newIsRotationFreezed, mIsRotationFreezed, mNbComponents * sizeof(bool));
    ...
    mJoints = newJoints;
    mIsRotationFreezed = newIsRotationFreezed;
}
...
void RigidBodyComponents::addComponent(Entity bodyEntity, bool isSleeping, const RigidBodyComponent& component) {
    ...
    mIsRotationFreezed[index] = false;
...
void RigidBodyComponents::moveComponentToIndex(uint32 srcIndex, uint32 destIndex) {
    ...
    mIsRotationFreezed[destIndex] = mIsRotationFreezed[srcIndex];
...
void RigidBodyComponents::swapComponents(uint32 index1, uint32 index2) {
    ...
    bool isRotationFreezed1 = mIsRotationFreezed[index1];
    ...
    mIsRotationFreezed[index2] = isRotationFreezed1;
