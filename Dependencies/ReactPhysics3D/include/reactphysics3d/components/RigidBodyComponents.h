...
class RigidBodyComponents : public Components {
    ...
    private:
        ...
        /// True if physics simulation should not affect rotation
        bool* mIsRotationFreezed;
    ...
    public:
        ...
        /// Enables or disables simulating rotation of a body
        void setIsRotationFreezed(Entity bodyEntity, bool isRotationFreezed);

        /// Tells if physics engine should simulate rotation of a body
        bool getIsRotationFreezed(Entity bodyEntity);
...
// Enables or disables simulation of rotation of a body
inline void RigidBodyComponents::setIsRotationFreezed(Entity bodyEntity, bool isRotationFreezed) {

   assert(mMapEntityToComponentIndex.containsKey(bodyEntity));
   mIsRotationFreezed[mMapEntityToComponentIndex[bodyEntity]] = isRotationFreezed;
}

// Tells if physics engine should simulate rotation of a body
inline bool RigidBodyComponents::getIsRotationFreezed(Entity bodyEntity) {
   
   assert(mMapEntityToComponentIndex.containsKey(bodyEntity));
   return mIsRotationFreezed[mMapEntityToComponentIndex[bodyEntity]];
}
